...
<link rel="shortcut icon"
	href="${pageContext.request.contextPath}/resources/images/icon/iconaEco.png" />
...
<body
	background="${pageContext.request.contextPath}/resources/images/icon/sfondologo.png">
	...
	<div id="container">
		<div class="row"
			style="padding-left: 24%; padding-right: 15%; padding-top: 20px; padding-bottom: 20px;">
				...
				<div id="first">
					<div class="myform form ">
						...
						<div style="padding-top: 30px" class="panel-body">
							...
							<!-- Login Form -->
							<form
								action="${pageContext.request.contextPath}/user/authenticateTheUser"
										...
										<div>
											...
											<c:if test="${param.error != null}">
												...
												<div class="alert alert-danger col-xs-offset-1 col-xs-10">
													param.error - Invalid username and password.</div>
