...
--
-- Table structure for table `finelavori`
--

DROP TABLE IF EXISTS `finelavori`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `finelavori` (
  `idFineLavori` int NOT NULL AUTO_INCREMENT,
  `dataFine` datetime DEFAULT NULL,
  `descrizione` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idFineLavori`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `finelavori`
--

LOCK TABLES `finelavori` WRITE;
/*!40000 ALTER TABLE `finelavori` DISABLE KEYS */;
INSERT INTO `finelavori` VALUES (1,NULL,'fine lavoro');
/*!40000 ALTER TABLE `finelavori` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `iniziolavori` (
  `idInizioLavori` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `iniziolavori` VALUES (1,NULL,'inizio lavoro');
...
CREATE TABLE `interventi` (
  ...
  `idInizioLavori` int DEFAULT NULL,
  `idFineLavori` int DEFAULT NULL,
  `idPrimoSal` int DEFAULT NULL,
  `idSecondoSal` int DEFAULT NULL,
  ...
  KEY `FK_Interventi_InizioLavori_idx` (`idInizioLavori`),
  KEY `FK_Interventi_FineLavori_idx` (`idFineLavori`),
  KEY `FK_Interventi_PrimoSal_idx` (`idPrimoSal`),
  KEY `FK_Interventi_SecondoSal_idx` (`idSecondoSal`),
  CONSTRAINT `FK_Interventi_FineLavori` FOREIGN KEY (`idFineLavori`) REFERENCES `finelavori` (`idFineLavori`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interventi_InizioLavori` FOREIGN KEY (`idInizioLavori`) REFERENCES `iniziolavori` (`idInizioLavori`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interventi_PrimoSal` FOREIGN KEY (`idPrimoSal`) REFERENCES `primosal` (`idPrimoSal`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interventi_Regioni` FOREIGN KEY (`idRegione`) REFERENCES `regioni` (`IdRegione`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK_Interventi_SecondoSal` FOREIGN KEY (`idSecondoSal`) REFERENCES `secondosal` (`idSecondoSal`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `interventi` VALUES (3,'TORINO','C','Intervento a gamba tesa','Sempre Simo','Diretto','Simo',12,NULL,NULL,NULL,NULL),(5,'TORINO','A','Sono un figo','Sempre Simo','Diretto','Simone',12,NULL,NULL,NULL,NULL),(6,'TORINO','B','Sono un figo','Sempre Simo','sotto','Simo',12,NULL,NULL,NULL,NULL),(7,'NAPOLI','A','boh','io','Lui','Simone',16,NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `interventi` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `primosal`
--

DROP TABLE IF EXISTS `primosal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `primosal` (
  `idPrimoSal` int NOT NULL AUTO_INCREMENT,
  `dataPrimoSal` datetime DEFAULT NULL,
  `descrizione` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idPrimoSal`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `primosal`
--

LOCK TABLES `primosal` WRITE;
/*!40000 ALTER TABLE `primosal` DISABLE KEYS */;
INSERT INTO `primosal` VALUES (1,NULL,'primosal');
/*!40000 ALTER TABLE `primosal` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `secondosal`
--

DROP TABLE IF EXISTS `secondosal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `secondosal` (
  `idSecondoSal` int NOT NULL AUTO_INCREMENT,
  `dataSecondoSal` datetime DEFAULT NULL,
  `descrizione` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idSecondoSal`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `secondosal`
--

LOCK TABLES `secondosal` WRITE;
/*!40000 ALTER TABLE `secondosal` DISABLE KEYS */;
INSERT INTO `secondosal` VALUES (1,NULL,'secondosal');
/*!40000 ALTER TABLE `secondosal` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-07-21 10:04:47
